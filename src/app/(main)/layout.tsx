...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <>
      ...
      {/* Layout wrapper instead of html/body */}
      <div className="min-h-screen w-screen flex flex-col bg-nude">
        <Nav />
        ...
        {isClientSide && (
          <a
            ...
            className="fixed bottom-12 right-12 bg-white/50 text-green flex items-center gap-2 px-4 py-2 rounded-full shadow-lg hover:bg-green-600 transition-all"
          >
            <svg
